...
<form method="POST" action="index.php" class="form-inline search_user">
    ...
    <input class="input-large auto-clear placeholder" type="text" placeholder="®user_ID®" title="®user_ID®" name="user_ID" value="<?php if(isset($input) && isset($input['user_ID'])) echo $input['user_ID']; ?>" />
    <input class="input-large auto-clear placeholder" type="text" placeholder="®forename®" title="®forename®" name="forename" value="<?php if(isset($input) && isset($input['forename'])) echo $input['forename']; ?>" />
    <input class="input-large auto-clear placeholder" type="text" placeholder="®surname®" title="®surname®" name="surname" value="<?php if(isset($input) && isset($input['surname'])) echo $input['surname']; ?>" />
