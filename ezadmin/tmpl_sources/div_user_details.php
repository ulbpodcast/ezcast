        ...
        <form class="form-horizontal" method="POST">
            ...
            <div class="edit">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="password" name="recorder_passwd"/>
                    </div>
                </div>
            </div>
        </form>
    ...
    <tbody>
        <?php foreach($courses as $c) { ?>
            <tr data-id="<?php echo $c['ID'] ?>" data-origin="<?php echo $u['origin'] ?>">
                ...
                <td><span class="label <?php if($c['origin'] == 'internal') echo 'label-info'; ?>"><?php if($c['origin'] == 'internal') echo '®intern®'; else echo '®extern®'; ?></span></td>
