        ...
        <div class="span8">
            ...
            <?php if($error) { ?>
                ...
                <div class="control-group">
                    ...
                    <div class="controls"><span class="label <?php if ($origin == 'internal') echo 'label-info'; ?>"><?php if ($origin == 'internal')
                        echo '®intern®';
                    else
                        echo '®extern®';
                    ?></span></div>
    ...
    <?php } ?>
                ...
                <div class="edit">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="password" name="recorder_passwd" placeholder="password"/><label>Laisser le champs vide pour concerser le mot de passe</label>
                        </div>
                    </div>
                </div>
            </form>
    ...
    <table class="table table-striped table-bordered table-hover courses_table">
        ...
        <tbody>
                ...
                <tr data-id="<?php echo $c['ID'] ?>" data-origin="<?php echo $u['origin'] ?>">
                    ...
                    <td><span class="label <?php if ($c['origin'] == 'internal') echo 'label-info'; ?>"><?php if ($c['origin'] == 'internal')
                        echo '®intern®';
                    else
                        echo '®extern®';
                    ?></span></td>
