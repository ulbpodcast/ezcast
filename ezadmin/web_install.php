...
{
    trigger_error("Install could not get repository path at path: $template_folder . This folder is generated by the install.sh script and should be readable.", E_USER_ERROR);
    die;
}
