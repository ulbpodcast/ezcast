...
$php_path ../commons/cli_template_generate.php $source_folder fr $dest_folder $current_dir/translations.xml;
$php_path ../commons/cli_template_generate.php $source_folder en $dest_folder $current_dir/translations.xml;
