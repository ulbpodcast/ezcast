 ...
 * @since 2011/06/10 
 * @author ULB <podcast@ulb.ac.be>
 * @package ezcast.ezmanager.lib.ezmam
 */
...
function ezmam_rss_generate($album, $type) {
    ...
    foreach ($assets as $asset) {
        ...
        if ($type == 'ezplayer') {
            add_item_to_rss(
                    $xmlh, $metadata['title'], $metadata['description'], $metadata['author'], get_RFC822_date($metadata['record_date']), false, false
            );
        } else {
