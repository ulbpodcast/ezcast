...
?>
  ...
  <div class="Colonne-Un-Information">
    ...
    <p><span class="infospodast">®Origin®&nbsp;:</span> <?php if($origin == 'SUBMIT') echo '®Manual_submit®'; else print_info($origin); ?></p>
   ...
   if($has_cam && $has_slides && $status != 'processing' && $status != 'failed') {
       ?>
