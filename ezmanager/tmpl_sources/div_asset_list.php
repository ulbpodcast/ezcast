    ...
    <div class="BlocPodcastMenu">
        ...
        if(isset($assets) && !empty($assets)) {
            foreach($assets as $asset) {
                ...
                ?>
                <div id="asset_<?php echo $asset_name; ?>" class="BoutonTriangle<?php if($status == 'failed') echo 'Error'; else if($status == 'processing') echo 'Processing'; ?>"> <a href="javascript:show_asset_details('<?php echo $album_name_full; ?>', '<?php echo $asset_name; ?>');"> <?php echo $date; ?> <span class="TitrePodcast" id="asset_<?php echo $asset_name; ?>_title"> | <?php echo htmlspecialchars($title); ?></span> </a> </div>
                <div id="asset_<?php echo $asset_name ?>_clic" class="BoutonTriangleClic<?php if($status == 'failed') echo 'Error'; else if($status == 'processing') echo 'Processing'; ?>" style="display:none"> <a href="javascript:show_asset_details('<?php echo $album_name_full; ?>', '<?php echo $asset_name; ?>');" ><?php echo $date; ?><span class="TitrePodcast" id="asset_<?php echo $asset_name; ?>_title_clic"> | <?php echo htmlspecialchars($title); ?></span> </a></div>
