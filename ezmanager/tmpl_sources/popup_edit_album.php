...
-->
<div class="popup" id="popup_edit_album" style="width: 415px; height: 230px;">
    <h2>®Edit_album®</h2>
       <div id="form">
           ...
           <input type="hidden" id="moderation" name="moderation" value="<?php echo $moderation; ?>"/>
             ...
             <script >
                 function submit_edit_form(){                 
                     ...
                     show_popup_from_outer_div('index.php?action=edit_album&session_id=<?php echo session_id();?>&album=<?php echo $album; ?>&moderation=<?php echo $moderation; ?>&intro='+intro+'&add_title='+add_title, true);
                 }
             </script>
       </form>
    </div>
