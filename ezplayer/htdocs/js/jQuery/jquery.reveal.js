...
----------------------------*/
    ...
    $.fn.reveal = function(options) {
        ...
        var defaults = {  
		    ...
		    dismissmodalclass: 'close-reveal-modal, .close-reveal-modal-button, .delete-button-confirm' //the class of a button or element that will close an open modal
    	}; 
			  ...
			  modalBG.unbind('click.modalEvent');
				...
				if(!locked) {
					...
					if(options.animation == "none") {
						modal.css({'displayt' : 'block', 'top':$(document).scrollTop()+topMeasure});
