...
php_path=$1;
if [ "$php_path" == "" ]; then php_path=php; fi;
...
$php_path $current_dir/../commons/cli_template_generate.php $source_folder fr $dest_folder $current_dir/translations.xml;
$php_path $current_dir/../commons/cli_template_generate.php $source_folder en $dest_folder $current_dir/translations.xml;
