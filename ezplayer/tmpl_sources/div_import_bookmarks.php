...
<?php if (isset($imported_bookmarks) && count($imported_bookmarks) > 0) { ?>
    <form action="index.php?action=import_bookmarks" method="post" id="select_import_bookmark_form" name="import_bookmark_form" onsubmit="return false">
    ...
    <?php } ?>
        ...
        <a href="#" onclick="submit_import_bookmarks_form('<?php echo $source; ?>');" id="import_button" class="simple-button blue" title="®Import_selected_bookmarks®">®Import®</a>
