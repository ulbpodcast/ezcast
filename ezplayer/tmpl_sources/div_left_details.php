...
<div id="main_player">
    ...
    <div id="site_map">
        ...
        if (acl_has_album_permissions($album)) {
            ...
            <a  href="javascript:show_album_assets('<?php echo $album; ?>', '<?php echo $token; ?>');" title="®Back_to_album®">(<?php if(isset($course_code_public) && $course_code_public!="") echo $course_code_public; else echo suffix_remove($album); ?>) <?php  echo get_album_title($album); ?></a>   
        <?php } ?>
