...
<div id="side_menu">
    ...
    <div class="settings bookmarks"> 
        ...
        <a class="sort-button <?php echo acl_value_get("personal_bm_order"); ?>" title="®Reverse_bookmarks_order®" href="javascript:bookmarks_sort('personal', '<?php echo (acl_value_get("personal_bm_order") == "chron") ? "reverse_chron" : "chron"; ?>', 'assets');"></a>
        <ul id="bookmarks_actions">
            <li><a href="javascript:popup_bookmarks('<?php echo $album; ?>', '', 'custom', 'assets', 'export')" title="®Export_album_bookmarks®">®Export_bookmarks®</a></li>  
            <li><a href="javascript:popup_bookmarks_import();" title="®Import_album_bookmarks®">®Import_bookmarks®</a></li>
            <li><a href="javascript:popup_bookmarks('<?php echo $album; ?>', '', 'custom', 'assets', 'delete')" title="®Delete_album_bookmarks®">®Delete_bookmarks®</a></li>                          
        </ul>
    </div>    
    <div class="settings toc">
        ...
        <a class="sort-button <?php echo acl_value_get("official_bm_order"); ?>" title="®Reverse_bookmarks_order®" href="javascript:bookmarks_sort('official', '<?php echo (acl_value_get("official_bm_order") == "chron") ? "reverse_chron" : "chron"; ?>', 'assets');"></a>
        <ul id="tocs_actions">
            <li><a href="javascript:popup_bookmarks('<?php echo $album; ?>', '', 'official', 'assets', 'export')" title="®Export_album_bookmarks®">®Export_bookmarks®</a></li>  
            <?php if (acl_user_is_logged() && acl_has_album_moderation($album)) { ?>
                <li><a href="javascript:popup_bookmarks_import();" title="®Import_album_bookmarks®">®Import_bookmarks®</a></li>
                <li><a href="javascript:popup_bookmarks('<?php echo $album; ?>', '', 'official', 'assets', 'delete')" title="®Delete_album_bookmarks®">®Delete_bookmarks®</a></li>                          
            <?php } ?>
        </ul>
    </div>
</div>
                    ...
                    foreach ($official_bookmarks as $index => $bookmark) {
                        ...
                        <li id="toc_<?php echo $index; ?>" class="orange level_<?php echo $bookmark['level']; ?>">
                            ...
                            <div class="bookmark_detail" id="toc_detail_<?php echo $index; ?>">
                                ...
                                <?php if (acl_user_is_logged() && acl_has_album_moderation($album)) { ?>
                                    <div class="bookmark_options">
                                        <a class="delete-button" title="®Delete_bookmark®" href="javascript:popup_bookmark('<?php echo $bookmark['album']; ?>', '<?php echo $bookmark['asset']; ?>', '<?php echo $bookmark['timecode']; ?>', 'official', 'assets', 'remove')"></a>
                                    </div>
                                <?php } ?>
                            </div>
                        </li>
