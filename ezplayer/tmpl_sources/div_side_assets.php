...
<?php if (!acl_user_is_logged() || ((!isset($album_bookmarks) || sizeof($album_bookmarks) == 0) && (isset($toc_bookmarks) && sizeof($toc_bookmarks) != 0))) { ?>
        current_tab = 'toc';
<?php } ?>
...
<div id="side_menu">
    ...
    <div class="settings bookmarks"> 
        ...
        <ul id="bookmarks_actions">
            <li><a href="javascript:bookmarks_popup('<?php echo $album; ?>', '', 'custom', 'assets', 'export')" title="®Export_album_bookmarks®">®Export_bookmarks®</a></li>  
            ...
            <li><a href="javascript:bookmarks_popup('<?php echo $album; ?>', '', 'custom', 'assets', 'delete')" title="®Delete_album_bookmarks®">®Delete_bookmarks®</a></li>                          
        </ul>
    </div>    
    <div class="settings toc">
        ...
        <ul id="tocs_actions">
            <li><a href="javascript:bookmarks_popup('<?php echo $album; ?>', '', 'official', 'assets', 'export')" title="®Export_album_bookmarks®">®Export_bookmarks®</a></li>  
            <?php if (acl_user_is_logged() && acl_has_album_moderation($album)) { ?>
                <li><a href="#" data-reveal-id="popup_import_bookmarks" onclick="makeRequest('index.php', '?action=view_import', 'popup_import_bookmarks');" title="®Import_album_bookmarks®">®Import_bookmarks®</a></li>
                <li><a href="javascript:bookmarks_popup('<?php echo $album; ?>', '', 'official', 'assets', 'delete')" title="®Delete_album_bookmarks®">®Delete_bookmarks®</a></li>                          
            <?php } ?>
        </ul>
    </div>
</div>
                            ...
                            <li id="bookmark_<?php echo $index; ?>" class="blue level_<?php echo $bookmark['level']; ?>">
                                ...
                                <div class="bookmark_detail" id="bookmark_detail_<?php echo $index; ?>">
                                    ...
                                    <div class="bookmark_options">
                                        <a class="delete-button" title="®Delete_bookmark®" href="javascript:bookmark_popup('<?php echo $bookmark['album']; ?>', '<?php echo $bookmark['asset']; ?>', '<?php echo $bookmark['timecode']; ?>', 'custom', 'assets', 'remove')"></a>
                                    </div>
                                </div>
                            </li>
                            <?php
                    ...
                    foreach ($toc_bookmarks as $index => $bookmark) {
                        ...
                        <li id="toc_<?php echo $index; ?>" class="orange level_<?php echo $bookmark['level']; ?>">
                            ...
                            <div class="bookmark_detail" id="toc_detail_<?php echo $index; ?>">
                                ...
                                <?php if (acl_user_is_logged() && acl_has_album_moderation($album)) { ?>
                                    <div class="bookmark_options">
                                        <a class="delete-button" title="®Delete_bookmark®" href="javascript:bookmark_popup('<?php echo $bookmark['album']; ?>', '<?php echo $bookmark['asset']; ?>', '<?php echo $bookmark['timecode']; ?>', 'official', 'assets', 'remove')"></a>
                                    </div>
                                <?php } ?>
                            </div>
                        </li>
