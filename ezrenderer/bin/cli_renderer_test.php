...
function test_ffmpeg($built_in_aac = true)
{
    global $ffmpegpath;
...
test_php();
if ($encoding_pgm['name'] == 'ffmpeg' || $encoding_pgm['name'] == 'ffmpeg_built_in_aac') {
    test_ffprobe();
    test_ffmpeg($encoding_pgm['name'] == 'ffmpeg_built_in_aac');
}
echo "test ok";
